...
export default function Cars(props:any) {
  ...
  return (
    <div className='py-4 px-4 bg-white h-full rounded-xl'>
      ...
      <div className='w-[100%] mt-14 flex justify-center'><Image src={props.img} alt="car image" className='w-[70%]'/></div>
      <div className='flex mt-12 justify-between'>
        <div className='flex gap-1'><Image src={gasStation} alt='petrol avg' className='w-5 h-5'/><span className='text-sm text-[#6B7280]'>{props.liter}L</span></div>
        ...
        <div className='flex gap-1'><Image src={Capacity} alt='petrol avg' className='w-5 h-5'/><span className='text-sm text-[#6B7280]'>{props.capacity}People</span></div>
      </div>
